                    ...
                    <div style={{ maxWidth: 1400, margin: '0 auto' }}>
                        ...
                        <div className="si-cat-grid">
                            {[
                                ...
                                { sw: 'si-sw-quartz', img: '/stones/quartz.png', name: 'Quartz', num: '08', tag: 'Designed consistency.', body: 'Unlike natural stone, quartz offers controlled patterns and lower maintenance. Clean, modern, practical, controlled.', best: 'kitchens · modern interiors · low-maintenance spaces', delay: 'si-d3' }
                            ].map(c => (
