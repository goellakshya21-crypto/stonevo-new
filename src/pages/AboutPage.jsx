...
// Skip the opening drone shot -- playback starts at frame_0038.webp instead
...
const AboutPage = () => {
    ...
    return (
        <div className="ab-root">
            <style>{`
                @import url('https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,300;0,400;0,700;0,900;1,300;1,400;1,700;1,900&family=Manrope:wght@300;400;500;700;800&display=swap');
                ...
                .ab-hero-tagline { font-family: var(--sans); font-size: 16px; font-weight: 300; line-height: 1.75; color: var(--cream); max-width: 42ch; margin-bottom: 24px; }
