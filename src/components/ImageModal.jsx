                ...
                <div className="w-full md:w-80 p-8 flex flex-col bg-white border-l border-stone-100 z-10">
                    <div className="mb-8">
                        ...
                        <div className="flex items-center gap-2 mb-4">
                            <span className="px-2 py-0.5 bg-stone-100 text-[10px] font-bold text-stone-500 uppercase rounded">{stone.physical_properties.type}</span>
                    ...
                    <div className="mt-auto space-y-4">
                        ...
                        {hasMultiple && (
                            <button
                                onClick={handleNext}
                                className="w-full md:hidden bg-stone-100 text-stone-900 py-3 px-6 text-[10px] font-bold uppercase tracking-widest hover:bg-stone-200 transition-all flex items-center justify-center gap-2 border border-stone-200"
                            >
